...
REM Abrir em nova janela PowerShell
start "FastAPI + Bot Controller" powershell -NoExit -Command "cd I:\Robo; .\venv\Scripts\activate; Write-Host '========================================' -ForegroundColor Cyan; Write-Host '  FASTAPI + BOT CONTROLLER' -ForegroundColor Cyan; Write-Host '========================================' -ForegroundColor Cyan; Write-Host ''; python -m uvicorn fastapi_app.main:app --host 0.0.0.0 --port 8001 --reload"
...
REM Abrir em nova janela PowerShell
start "Streamlit Dashboard" powershell -NoExit -Command "cd I:\Robo; .\venv\Scripts\activate; Write-Host '========================================' -ForegroundColor Green; Write-Host '  STREAMLIT DASHBOARD' -ForegroundColor Green; Write-Host '========================================' -ForegroundColor Green; Write-Host ''; streamlit run dashboard_streamlit_fastapi.py --server.port 8501"
