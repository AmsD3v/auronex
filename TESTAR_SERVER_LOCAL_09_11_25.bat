...
start "2-Dashboard-React-8501" cmd /k "title Dashboard React DEV (8501) && cd /d I:\Robo\auronex-dashboard && echo ============================================================ && echo   DASHBOARD REACT - MODO DEV (HOT RELOAD) && echo   APIs: http://localhost:8001 (NAO producao!) && echo ============================================================ && echo. && echo AGUARDE COMPILAR... && npm run dev"
