      ...
      <main className="container mx-auto px-6 py-8 relative">
        ...
        {botsError && (
          <div className="mb-6 rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-4">
            <p className="text-sm text-yellow-500">
              ...
              <a href="http://localhost:8001/bots-page" target="_blank" className="underline font-semibold">
                Gerenciar Bots
              </a>
            </p>
          </div>
        ...
        {balanceError && (
          <div className="mb-6 rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-4">
            <p className="text-sm text-yellow-500">
              ...
              <a href="http://localhost:8001/api-keys-page" target="_blank" className="underline font-semibold">
                API Keys
              </a>
            </p>
          </div>
        ...
        <div className="mt-8 card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              href="http://localhost:8001/bots-page"
              target="_blank"
